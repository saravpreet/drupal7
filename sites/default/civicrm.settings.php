...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://sarav:&~Q_k2U"pb+{aHnZ<)N~@localhost/DRUPAL7?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://sarav:&~Q_k2U"pb+{aHnZ<)N~@localhost:3306/CRM?new_link=true');
  }
}
...
$civicrm_root = '/home/vagrant/code/drupal7/sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/home/vagrant/code/drupal7/sites/default/files/civicrm/templates_c/');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://local.drupal7/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '2d04d5d0538beba550d6dc9aaf36b71c');
}
...
// define( 'CIVICRM_MAIL_LOG', '/home/vagrant/code/drupal7/sites/default/files/civicrm/templates_c//mail.log');
// }
